...
本文件为 Codex (Codex.ai/code) 提供代码仓库的工作指导。
...
| 文件 | 内容 |
|------|------|
| [.Codex/behavior.md](./.Codex/behavior.md) | Codex 编码行为准则 |
| [.Codex/guide.md](./.Codex/guide.md) | Codex 使用方法、协作最佳实践 |
| [.Codex/patterns.md](./.Codex/patterns.md) | 项目特有代码模式和模板 |
| [.Codex/debugging.md](./.Codex/debugging.md) | 常见问题诊断与解决方案 |
...
1. **入门** - 阅读本文档了解项目结构
2. **准则** - 学习 [.Codex/behavior.md](./.Codex/behavior.md) 掌握编码行为原则
3. **进阶** - 学习 [.Codex/guide.md](./.Codex/guide.md) 掌握 Codex 协作技巧
4. **实践** - 参考 [.Codex/patterns.md](./.Codex/patterns.md) 使用代码模板
5. **排错** - 遇到问题查阅 [.Codex/debugging.md](./.Codex/debugging.md)
