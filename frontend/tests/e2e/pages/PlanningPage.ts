...
export class PlanningPage {
  ...
  constructor(page: Page) {
    ...
    this.sessionIdInput = page
      .locator('input[placeholder*="Session"]')
      .or(page.locator('.el-form-item:has-text("Session") input'))
  ...
  async clearHistory() {
    ...
    // 确认对话框
    await this.page
      .locator('.el-message-box__headerBtn + .el-message-box__btns button')
      .first()
      .click()
  }
