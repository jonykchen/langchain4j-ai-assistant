...
public class AgentTraceSpan {
     ...
     * 创建工具执行 Span
     */
    public static AgentTraceSpan toolCall(String traceId, String toolName, String params,
     ...
     * 创建 LLM 调用 Span
     */
    public static AgentTraceSpan llmCall(String traceId, String prompt, String response,
