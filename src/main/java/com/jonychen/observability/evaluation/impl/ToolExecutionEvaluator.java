...
public class ToolExecutionEvaluator implements AgentEvaluator {
    ...
    public EvaluationResult evaluate(EvaluationContext context) {
        ...
        List<Map<String, Object>> toolSpans = trace.getSpans().stream()
        ...
        // 统计成功/失败
        long successCount = toolSpans.stream()
    ...
    public BatchEvaluationResult evaluateBatch(List<AgentTrace> traces) {
        ...
        return new BatchEvaluationResult(
                ...
                Map.of(
                        ...
                        "avgToolSuccessRate", traces.isEmpty() ? 0 : totalSuccessRate / traces.size()
                )
        );
    }
