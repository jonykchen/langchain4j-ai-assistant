...
public class EvaluationMetrics {
     ...
     */
    @Builder.Default
    private double avgIterations = 0.0;

    /**
     * 工具调用成功率
     */
    @Builder.Default
    private double toolSuccessRate = 0.0;
     ...
     */
    @Builder.Default
    private double avgTokenUsage = 0.0;
     ...
     */
    @Builder.Default
    private double thoughtQualityScore = 0.0;

    /**
     * 最终答案相关性
     */
    @Builder.Default
    private double answerRelevanceScore = 0.0;
     ...
     */
    @Builder.Default
    private double endToEndSuccessRate = 0.0;
