...
public record CostStatistics(
    ...
    public record TrendData(
            List<String> dates, List<Long> tokens, List<Double> costs, List<Long> requests) {}

    /** 用户消费排行 */
    public record UserCostRanking(String userId, String username, long tokens, double cost) {}

    /** 模型分布 */
    public record ModelDistribution(String name, long value) {}
}
