...
public interface TokenUsageRepository extends JpaRepository<TokenUsageLog, Long> {
    ...
    @Query("""
            ...
            """)
    List<Object[]> getUsageSummary(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);

    /**
     * 统计时间范围内的活跃用户数
     */
    @Query("SELECT COUNT(DISTINCT t.userId) FROM TokenUsageLog t WHERE t.createdAt >= :start AND t.createdAt < :end")
    ...
    @Query("""
            ...
            """)
    List<Object[]> getModelDistribution(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
    ...
    @Query("""
            ...
            """)
    List<Object[]> getModelCostStatistics(@Param("start") LocalDateTime start, @Param("end") LocalDateTime end);
    ...
    @Query("""
            ...
            LIMIT :limit
            """)
    List<Object[]> getTopUsersByCost(@Param("start") LocalDateTime start,
    ...
    @Query("""
            ...
            """)
    List<Object[]> getUserUsage(@Param("userId") String userId,
