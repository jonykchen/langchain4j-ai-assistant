...
public class AdminController {
    ...
    public ApiResponse<UserAdminService.UserUsageStats> getUserUsageStats(@PathVariable String userId) {
    ...
    public ApiResponse<Void> updateUserQuota(
            @PathVariable String userId,
            @RequestBody UserAdminService.QuotaUpdateRequest request
    ) {
