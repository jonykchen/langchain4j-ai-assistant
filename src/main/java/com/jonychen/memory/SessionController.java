...
public class SessionController {
    ...
    public SessionInfo createSession(
            Principal principal, @RequestBody(required = false) CreateSessionRequest request) {
    ...
    public SessionInfo getSession(Principal principal, @PathVariable String sessionId) {
        String userId = getUserId(principal);
