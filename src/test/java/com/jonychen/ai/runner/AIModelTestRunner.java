...
public class AIModelTestRunner {
        ...
        return Stream.of(
            ...
            new AIModelTestCase(
                ...
                List.of(
                    ...
                    new AIModelTestCase.Assertion("RESPONSE_TIME_MS", "响应时间在5秒内", "5000", 0.0)
                ),
            ...
            new AIModelTestCase(
                ...
                List.of(
                    ...
                    new AIModelTestCase.Assertion("LENGTH_MIN", "回复长度至少10字符", "10", 0.0)
                ),
                Map.of("difficulty", "easy")
            ),
            ...
            new AIModelTestCase(
                ...
                "用 Java 实现冒泡排序",
                List.of(
                    new AIModelTestCase.Assertion("CONTAINS", "包含 Java 代码块", "```java", 0.0),
            ...
            new AIModelTestCase(
                ...
                List.of(
                    new AIModelTestCase.Assertion("CONTAINS", "包含 Python 代码块", "```python", 0.0),
                    new AIModelTestCase.Assertion("MATCHES_REGEX", "包含 HTTP 相关代码", "http|HTTP|socket", 0.0)
                ),
                Map.of("difficulty", "medium")
            ),
            ...
            new AIModelTestCase(
                ...
                List.of(
                    ...
                    new AIModelTestCase.Assertion("LENGTH_MIN", "回复长度至少50字符", "50", 0.0)
                ),
                Map.of("difficulty", "medium")
            ),
            ...
            new AIModelTestCase(
                ...
                List.of(
                    ...
                    new AIModelTestCase.Assertion("LENGTH_MIN", "回复长度至少30字符", "30", 0.0)
                ),
                Map.of("difficulty", "medium")
            )
        );
    ...
    void runAiModelTest(AIModelTestCase testCase) {
        ...
        assert result.score() >= 0.8 :
            "Test failed with score: " + result.score() + ", failed assertions: " + result.failed();
    }
